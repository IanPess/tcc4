  ...
  function changeBackgroundByTime(weatherCode) {
    ...
    if (weatherCode >= 0 && weatherCode <= 2) {
        ...
        backgroundUrl = (currentHour >= 18 || currentHour < 6) 
            ? "url('https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?fit=crop&w=1950&q=80')" // Noite clara
            : "url('https://images.unsplash.com/photo-1488972685288-c3fd157d7c7a?fit=crop&w=1950&q=80')"; // Dia ensolarado
    } else if (weatherCode >= 3 && weatherCode <= 4) {
        // Clima nublado
        backgroundUrl = (currentHour >= 18 || currentHour < 6) 
            ? "url('https://images.unsplash.com/photo-1527772831673-b3c2eec2d216?fit=crop&w=1950&q=80')" // Noite nublada
            : "url('https://images.unsplash.com/photo-1510557880182-3b16f0e924e1?fit=crop&w=1950&q=80')"; // Dia nublado
    } else if (weatherCode >= 5 && weatherCode <= 7) {
        // Chuva ou tempestade
        backgroundUrl = (currentHour >= 18 || currentHour < 6) 
            ? "url('https://images.unsplash.com/photo-1497581175340-3f09c95e3af7?fit=crop&w=1950&q=80')" // Noite chuvosa
            : "url('https://images.unsplash.com/photo-1444384851176-6e23071c6127?fit=crop&w=1950&q=80')"; // Dia chuvoso
    } else {
        // Clima desconhecido ou outros casos
        backgroundUrl = "url('https://as2.ftcdn.net/v2/jpg/06/46/41/03/1000_F_646410322_YKC8bYlPRfeVUETHScgvyv3GfrDAmTf8.jpg')"; // Fundo padrão
    }

    // Aplicar a imagem de fundo
    body.style.backgroundImage = backgroundUrl;
    body.style.backgroundSize = 'cover';  // Garante que a imagem cubra toda a tela
